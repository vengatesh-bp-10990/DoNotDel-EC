...
function Signup() {
  ...
  const signUpInitRef = useRef(false);
    ...
    <div className="min-h-[calc(100vh-64px)] flex">
      ...
      <div className="flex-1 flex items-center justify-center px-4 sm:px-8 py-6 sm:py-8 bg-gradient-to-br from-gray-50 to-white overflow-y-auto">
        <div className="w-full max-w-md">
          ...
          {/* Catalyst Embedded Sign-Up Container */}
          ...
          <div className="mt-5 text-center">
            <p className="text-sm text-gray-500">
              ...
              <a href="/login" className="font-semibold text-amber-600 hover:text-amber-700 underline underline-offset-2 transition-colors">
                Sign In
              </a>
            </p>
          </div>
